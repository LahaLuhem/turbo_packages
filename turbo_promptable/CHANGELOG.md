...
### Fixed
- Removed unused `@JsonSerializable` annotation from abstract `TPromptable` class — it generated an unreferenced `_$TPromptableToJson` function since subclasses handle their own serialization
- Added dartdoc comments to public members in `TPromptable`
