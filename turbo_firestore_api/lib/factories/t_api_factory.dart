...
class TApiFactory<DTO extends TWriteableId, MODEL extends TModel<DTO>> {
  TApiFactory({required TFirestoreCollection<DTO, MODEL> collection}) : _collection = collection;

  final TFirestoreCollection<DTO, MODEL> _collection;

  TFirestoreApi<DTO, MODEL> create({
